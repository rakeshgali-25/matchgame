...
class GameMatch extends Component {
  ...
  render() {
    const {tabItem, randomImg, score, timer, gameOver} = this.state

    const getFilteredList = imagesList.filter(each => each.category === tabItem)
        ...
        {gameOver ? (
          ...
          <div className="contianer">
            <div className="big-image-container">
              <img src={randomImg} alt="match" className="big-image" />
            </div>
